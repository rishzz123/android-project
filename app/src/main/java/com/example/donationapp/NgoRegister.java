...
public class NgoRegister extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener,
        LocationListener {
    TextInputEditText ngoNameEt, ngoEmailEt, ngoPhoneEt, ngoAddressEt;

    String mFromTime, mToTime, ngoName, ngoEmail, ngoPhone, ngoAddress;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ngoAddressEt = findViewById(R.id.ngoAddress);
        ...
        rootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onClick(View view) {
                ...
                ngoAddress = ngoAddressEt.getText().toString();
                ...
                if (TextUtils.isEmpty(ngoName)) {
                    ...
                    ngoAddressEt.setError("Please Enter Address");
                    ngoAddressEt.requestFocus();
                } else if (fromTimeZone == 0) {
                    Toast.makeText(NgoRegister.this, "Please Select Available From Time", Toast.LENGTH_SHORT).show();
                } else if (toTimeZone == 0) {
                    Toast.makeText(NgoRegister.this, "Please Select Available To Time", Toast.LENGTH_SHORT).show();

                } else {

                    final ProgressDialog progressDialog = new ProgressDialog(NgoRegister.this);
                    ...
                    for (String str : resultArr) {
                        ...
                        userDatabase = FirebaseDatabase.getInstance().getReference().child("User").child("NGO").child(uId).child(str);
                        ...
                        userDetails.put("Address", ngoAddress);
                    ...
                    userDatabase.updateChildren(userDetails).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            Intent intent = new Intent(NgoRegister.this, NgoWorkingDays.class);
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(NgoRegister.this, (CharSequence) e, Toast.LENGTH_SHORT).show();
                        }
                    });
    ...
    public void selectFromTime(View view) {
        ...
        fromTimePickerDialog = new TimePickerDialog(NgoRegister.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
    ...
    public void selectToTime(View view) {
        ...
        toTimePickerDialog = new TimePickerDialog(NgoRegister.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
            public void onTimeSet(TimePicker timePicker, int hourOfDay, int minute) {
                toTimeZone = 1;
    ...
    private void getMyLocation() {
        if (googleApiClient != null) {
            if (googleApiClient.isConnected()) {
                int permissionLocation = ContextCompat.checkSelfPermission(NgoRegister.this,
                            ...
                            switch (status.getStatusCode()) {
                                case LocationSettingsStatusCodes.SUCCESS:
                                    ...
                                    int permissionLocation = ContextCompat
                                            .checkSelfPermission(NgoRegister.this,
                                                    Manifest.permission.ACCESS_FINE_LOCATION);
                                    if (permissionLocation == PackageManager.PERMISSION_GRANTED) {
                                ...
                                case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                    ...
                                    try {
                                        ...
                                        status.startResolutionForResult(NgoRegister.this,
