...
public class VolWorkingDays extends AppCompatActivity {
        ...
        findViewById(R.id.saveButton).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (outputCategory.length == 0) {
                    ...
                    final ProgressDialog progressDialog = new ProgressDialog(VolWorkingDays.this);
                    ...
                    for (String str : resultArr) {
                        DatabaseReference weekData=FirebaseDatabase.getInstance().getReference().child("User").child("Volunteer").child(uId).child(str);
                    ...
                    userDatabase.updateChildren(userDetails).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            Intent intent1 = new Intent(VolWorkingDays.this, MainActivity.class);
